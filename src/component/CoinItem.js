...
class CoinList extends Component {
  ...
  render() {
    const covert = this.props.cuy.toUpperCase().split('-');
    const buttons = [
      {
        text: '编辑',
 ...
 backgroundColor: '#f9f9f9', marginTop: 0, marginBottom: 1, height: 60
}} underlayColor={'#ccc'} onPress={
                    ...
                    <View style={styles.cell}>
                        ...
                        <View style={styles.rightContainer}>
                            ...
                            <View style={{
marginTop: 8, flex: 1, flexDirection: 'row', alignItems: 'stretch', justifyContent: 'space-between'
}}>
